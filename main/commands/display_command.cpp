...
BUNNY_COMMAND(display_commands) {
    Bunny.command("fillScreen")
        ...
        .execute(bunny::display::cmd_fill_screen);
    ...
    Bunny.command("drawText")
        ...
        .execute(bunny::display::cmd_draw_text);
